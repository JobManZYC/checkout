...
public class MerchantController {
    ...
    @GetMapping("/page")
    public Result<Page<MerchantVO>> page(
        ...
        Page<MerchantVO> result = merchantService.page(page, pageSize, keyword);
        return Result.success(result);
    }

    @ApiOperation("根据ID查询商户")
    @GetMapping("/getById")
    public Result<MerchantVO> getById(
    ...
    public Result<Integer> save(
        ...
        return Result.success(merchantService.save(dto));
    }
